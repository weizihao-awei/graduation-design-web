<template>
  <div class="recommend-articles-page">
    <Header />
    ...
    <div class="container">
      <div class="page-header">
        ...
        <p class="page-description">基于您的兴趣为您推荐</p>
      </div>
      ...
      <div class="content-grid">
        <div class="main-section">
          ...
          <el-empty v-if="!loading && articles.length === 0" description="暂无推荐文章" />
        </div>
